...
import { BiSupport } from "react-icons/bi";
 ...
 const services = [
  ...
  
  {
    ...
    description: "Building responsive, user-friendly interfaces using HTML, CSS, JavaScript, React, Nextjs, and related technologies."
  },
  {
    icon:<CiDatabase/>,
...
export default function Services() {
    ...
    return (
        <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">I am a fullstack developer from Bangladesh</p>
